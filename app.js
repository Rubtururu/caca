...
// ABI recortada para simplificar ejemplo, puedes usar la completa si lo deseas.
...
document.getElementById("withdrawStakeBtn").addEventListener("click", async () => {
  try {
...
document.getElementById("withdrawRewardsBtn").addEventListener("click", async () => {
  try {
